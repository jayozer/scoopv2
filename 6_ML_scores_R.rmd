...
# Initially I missed having the predictor as a factor. I am still a rookie!
```
...
ppru.rpart_try <- predict(mpru.rpart_try, inspection_scoresV2_test[,-9], type = "class") 
...
ppru.rpart_try2 <- predict(mpru.rpart_try2, inspection_scoresV2_test[,-9], type = "class") 
mean(ppru.rpart_try2 == inspection_scoresV2_test$score)
#Accuracy results are lower. cp value represents the cost of adding node to the tree. the default value 0.01 seems like the the best choice. The second plot shows a simpler decision tree where shell weight is the predictor for a binary (harvest or not) classifier.
```
